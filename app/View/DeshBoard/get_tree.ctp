...
<body onload="init()">
<div id="work">
  <div id="fullDiagram" style="height:200px;width:100%;border:1px solid black;margin:2px"></div>
  <div id="localDiagram" style="height:400px;width:100%;border:0px solid black;margin:2px"></div>  
</div>
</body>
